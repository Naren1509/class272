$(function () {
    ...
    var font_style = document.getElementById('font')
    ...
    function syncDrawingData(data) {
        ...
        if(data.textarea_font == "serif"){
            document.getElementById('text_area').style.fontFamily = "serif";
        }
        if(data.textarea_font == "sans-serif"){
            document.getElementById('text_area').style.fontFamily = "sans-serif";
        }
        if(data.textarea_font == "bold"){
            document.getElementById('text_area').style.fontFamily = "bold";
        }
    ...
    function messageSync()
{
    ...
    function font_change(){
        selected_font_colour = document.getElementById('font').value;
        if(selected_font_colour == "serif"){
            font_value = "serif"
        }
        if(selected_font_colour == "bold"){
            font_value = "bold"
        }
        if(selected_font_colour == "sans-serif"){
    ...
    font_style.addEventListener("change",font_change)
});
